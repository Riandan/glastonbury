    ...
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <main className="flex-1">
        <section className="relative w-full h-[80vh] overflow-hidden">
          <video src="/glastonbury-hero.mp4" autoPlay loop muted className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-[#6366F1]/50 flex flex-col items-center justify-center text-center space-y-4 px-4">
            ...
            <p className="max-w-[600px] text-[#F3F4F6] md:text-xl">
              Experience the ultimate music festival in the heart of Rainhill, UK. Featuring the biggest names in music,
              arts, and culture.
            </p>
          </div>
        </section>
        <section id="event-details" className="w-full py-12 md:py-24 lg:py-32 bg-[#F3F4F6] dark:bg-[#1F2937]">
          <div className="container px-4 md:px-6 space-y-8">
            <div className="space-y-2 text-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-[#6366F1]">Event Details</h2>
              <p className="max-w-[600px] mx-auto text-[#4B5563] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-[#D1D5DB]">
                Glastonbury Festival is the largest greenfield music and performing arts festival in the world. It takes
                place in Rainhill, England.
              </p>
            </div>
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <div className="space-y-1">
                <h3 className="text-xl font-bold text-[#6366F1]">Date</h3>
                <p className="text-[#4B5563] dark:text-[#D1D5DB]">June 21 - June 25, 2023</p>
              </div>
              <div className="space-y-1">
                <h3 className="text-xl font-bold text-[#6366F1]">Location</h3>
                <p className="text-[#4B5563] dark:text-[#D1D5DB]">Worthy Farm, Pilton, Somerset, UK</p>
              </div>
              <div className="space-y-1">
                <h3 className="text-xl font-bold text-[#6366F1]">Overview</h3>
                <p className="text-[#4B5563] dark:text-[#D1D5DB]">
                  Glastonbury Festival is a five-day music festival that takes place in late June at Worthy Farm in
                  Pilton, Somerset, England. It is one of the largest music festivals in the world and a major event in
                  British culture.
                </p>
              </div>
            </div>
        ...
        <section id="lineup" className="w-full py-12 md:py-24 lg:py-32 bg-[#F3F4F6] dark:bg-[#1F2937]">
          <div className="container px-4 md:px-6 space-y-8">
            <div className="space-y-2 text-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-[#6366F1]">Lineup</h2>
              <p className="max-w-[600px] mx-auto text-[#4B5563] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-[#D1D5DB]">
                Check out the incredible lineup of artists performing at this year's Glastonbury Festival.
              </p>
            </div>
            <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              <div className="flex flex-col items-center space-y-2">
                ...
                />
                <h3 className="text-lg font-bold text-[#6366F1]">Billie Eilish</h3>
              ...
              <div className="flex flex-col items-center space-y-2">
                <img
                  ...
                  className="rounded-full w-20 h-20 object-cover border-4 border-[#6366F1]"
                />
                <h3 className="text-lg font-bold text-[#6366F1]">Kendrick Lamar</h3>
                <p className="text-[#4B5563] dark:text-[#D1D5DB]">Headliner</p>
              </div>
              <div className="flex flex-col items-center space-y-2">
                <img
        ...
        <section id="tickets" className="w-full py-12 md:py-24 lg:py-32 bg-[#F3F4F6] dark:bg-[#1F2937]">
          <div className="container px-4 md:px-6 space-y-8">
            <div className="space-y-2 text-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-[#6366F1]">Get Your Tickets</h2>
              <p className="max-w-[600px] mx-auto text-[#4B5563] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-[#D1D5DB]">
                Don't miss your chance to experience the magic of Glastonbury Festival. Secure your tickets now before
                they sell out.
              </p>
            </div>
      ...
      <footer className="bg-[#6366F1] text-[#F3F4F6] p-6 md:py-12 w-full">
        <div className="container max-w-7xl grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 text-sm">
          <div className="grid gap-1">
            ...
            <Link href="#" className="hover:underline underline-offset-4 text-[#F3F4F6]" prefetch={false}>
              About
            </Link>
            <Link href="#" className="hover:underline underline-offset-4 text-[#F3F4F6]" prefetch={false}>
              History
